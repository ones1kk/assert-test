...
class CharacterAssertTest {
    ...
    void test1() {
        CharacterAssert<?, Character> characterAssert = new CharacterAssert(CharacterAssert.class,
            Character.class);
        Assertions.assertThat(characterAssert).isInstanceOf(Assert.class)
            .isInstanceOf(CharacterAssert.class);
    }
